...
let sizeOfPeople = got.houses[0].people.length;
console.log(sizeOfPeople);
// 13. Log the size of people in Lannisters house
let sizeOfPeople = got.houses[1].people.length;
console.log(sizeOfPeople);
// 14. Add the name and size of people in an object like {Starks: 4, Lannisters: 6} and log the object
let nameAndSize = {};
nameAndSize.Starks = got.houses[0].people.length;
