...
let colors = ["red", "green", "white", "black", "yellow"];
...
// 7. Write one line of code that changes the value of the first color in the list to "blue" (overwriting the previous value).
colors[0] = "blue";
...
let fourthColor = ["green", "blue", "white", "yellow"];
// 11. Add another color to the end of the list.
fourthColor[fourthColor.length] = "black";
